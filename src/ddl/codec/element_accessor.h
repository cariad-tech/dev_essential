...
public:
    virtual a_util::result::Result getValue(const StructLayoutElement& element,
                                            const void* data,
                                            size_t data_size,
                                            void* element_value) const = 0;
    virtual a_util::result::Result setValue(const StructLayoutElement& element,
                                            void* data,
                                            size_t data_size,
    ...
    a_util::result::Result getValue(const StructLayoutElement& element,
                                    const void* data,
                                    size_t data_size,
                                    a_util::variant::Variant& value) const;

    a_util::result::Result setValue(const StructLayoutElement& element,
                                    void* data,
                                    size_t data_size,
