...
public:
     ...
     *
     * @param [in] dd The DataDefinition information base used for type lookup
     ...
     *                    (see error list for details)
     * @retval ERR_INVALID_TYPE Configuration uses unknown DataDefinition types
     *                          (see error list for details)
     * @retval a_util::result::SUCCESS Everything went fine
     */
    ...
    /**
     * Import mapping configuration from a XML dom instance without checking for DataDefinition
     * consistency
     *
     * @param [in] dom The dom instance from which to import
     * @param [in] flags Options for loading. See \ref MapConfigFlags
     ...
     * Modell is loaded even if it is not consistent with the DataDefinition description
    ...
    /**
     * Import mapping configuration from a XML dom instance
     * Modell is laoding even if it is not consistent with the DataDefinition description
     * Each element has a validity flag representing its consistency
     *
     * @param [in] dom The dom instance from which to import
     * @param [in] flags Options for loading. See \ref MapConfigFlags
    ...
    /**
     * Returns bool flag indicating whether consistency of mapping with its DataDefinition was
     * already checked
...
private:
     ...
     * @retval ERR_INVALID_TYPE Type not found in DataDefinition
     * @retval a_util::result::SUCCESS      Everything went fine
     */
    ...
    a_util::result::Result checkAssignmentType(const std::string& signal_name,
                                               ...
                                               const MapAssignment& assignment) const;
...
private:
    ...
    std::shared_ptr<const ddl::dd::datamodel::DataDefinition> _ddl_ref;
