...
PredefinedDataTypes::PredefinedDataTypes()
    : _defined_types{{"bool", {std::make_shared<DataType<bool>>("bool"), {"tBool"}}},
                     ...
                     {"uint8_t", {std::make_shared<DataType<uint8_t>>("uint8_t"), {"tUInt8"}}},
                     {"int8_t", {std::make_shared<DataType<int8_t>>("int8_t"), {"tInt8"}}},
                     {"tUInt8", {std::make_shared<DataType<uint8_t>>("tUInt8"), {"uint8_t"}}},
                     {"tInt8", {std::make_shared<DataType<int8_t>>("tInt8"), {"int8_t"}}},
                     {"uint16_t", {std::make_shared<DataType<uint16_t>>("uint16_t"), {"tUInt16"}}},
                     {"int16_t", {std::make_shared<DataType<int16_t>>("int16_t"), {"tInt16"}}},
                     {"tUInt16", {std::make_shared<DataType<uint16_t>>("tUInt16"), {"uint16_t"}}},
                     {"tInt16", {std::make_shared<DataType<int16_t>>("tInt16"), {"int16_t"}}},
                     {"uint32_t", {std::make_shared<DataType<uint32_t>>("uint32_t"), {"tUInt32"}}},
                     {"int32_t", {std::make_shared<DataType<int32_t>>("int32_t"), {"tInt32"}}},
                     {"tUInt32", {std::make_shared<DataType<uint32_t>>("tUInt32"), {"uint32_t"}}},
                     {"tInt32", {std::make_shared<DataType<int32_t>>("tInt32"), {"int32_t"}}},
                     {"uint64_t", {std::make_shared<DataType<uint64_t>>("uint64_t"), {"tUInt64"}}},
                     {"int64_t", {std::make_shared<DataType<int64_t>>("int64_t"), {"tInt64"}}},
                     {"tUInt64", {std::make_shared<DataType<uint64_t>>("tUInt64"), {"uint64_t"}}},
                     {"tInt64", {std::make_shared<DataType<int64_t>>("tInt64"), {"int64_t"}}},
