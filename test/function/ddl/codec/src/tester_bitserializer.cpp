 ...
 * @req_id
 */
TEST(CodecTest, BitSerializerTestReadValue)
{
    ...
    ASSERT_EQ(value, 0x7766554433221100ULL);

    ASSERT_EQ(a_util::result::SUCCESS, pBits->read(0, 56, &value, bit_little_endian));

    ASSERT_EQ(value, 0x0066554433221100ULL);
    ...
    ASSERT_EQ(value, 0x0011223344556677ULL);

    ASSERT_EQ(a_util::result::SUCCESS, pBits->read(0, 56, &value, bit_big_endian));

    ASSERT_EQ(value, 0x0000112233445566ULL);
    ...
    ASSERT_EQ(value, 0x8088776655443322ULL);

    ASSERT_EQ(a_util::result::SUCCESS, pBits->read(4, 16, &value, bit_little_endian));

    ASSERT_EQ(value, 0x2110);

    ASSERT_EQ(a_util::result::SUCCESS, pBits->read(40, 16, &value, bit_little_endian));

    ASSERT_EQ(value, 0x6655);

    ASSERT_EQ(a_util::result::SUCCESS, pBits->read(16, 16, &value, bit_little_endian));

    ASSERT_EQ(value, 0x3322);

    ASSERT_EQ(a_util::result::SUCCESS,
              pBits->read(12, 64, &value, bit_little_endian)); // Read value from 9 buffer bytes

    ASSERT_EQ(value, 0x0887766554433221ULL);

    ASSERT_EQ(a_util::result::SUCCESS,
              pBits->read(4, 64, &value, bit_little_endian)); // Read value from 9 buffer bytes

    ASSERT_EQ(value, 0x8776655443322110ULL);

    ASSERT_EQ(a_util::result::SUCCESS, pBits->read(4, 16, &value, bit_big_endian));

    ASSERT_EQ(value, 0x1021);

    ASSERT_EQ(a_util::result::SUCCESS, pBits->read(40, 16, &value, bit_big_endian));

    ASSERT_EQ(value, 0x5566);

    ASSERT_EQ(a_util::result::SUCCESS, pBits->read(16, 16, &value, bit_big_endian));

    ASSERT_EQ(value, 0x2233);

    ASSERT_EQ(a_util::result::SUCCESS,
              pBits->read(4, 64, &value, bit_big_endian)); // Read value from 9 buffer bytes

    ASSERT_EQ(value, 0x1021324354657687ULL);

    // Read partial unaligned bytes

    ASSERT_EQ(a_util::result::SUCCESS, pBits->read(4, 13, &value, bit_little_endian));

    ASSERT_EQ(value, 0x0110);

    ASSERT_EQ(a_util::result::SUCCESS, pBits->read(40, 17, &value, bit_little_endian));

    ASSERT_EQ(value, 0x00016655);

    ASSERT_EQ(a_util::result::SUCCESS, pBits->read(11, 10, &value, bit_little_endian));

    ASSERT_EQ(value, 0x0042);

    ASSERT_EQ(a_util::result::SUCCESS, pBits->read(1, 61, &value, bit_little_endian));

    ASSERT_EQ(value, 0x1BB32AA219910880ULL);

    ASSERT_EQ(a_util::result::SUCCESS,
              pBits->read(4, 63, &value, bit_little_endian)); // Read value from 9 buffer bytes

    ASSERT_EQ(value, 0x0776655443322110ULL);

    ASSERT_EQ(a_util::result::SUCCESS,
              pBits->read(12, 61, &value, bit_little_endian)); // Read value from 9 buffer bytes
    ...
    ASSERT_EQ(value, 0x00012ab3);

    ASSERT_EQ(a_util::result::SUCCESS, pBits->read(10, 10, &value, bit_big_endian));

    ASSERT_EQ(value, 0x0021);

    ASSERT_EQ(a_util::result::SUCCESS,
              pBits->read(5, 61, &value, bit_big_endian)); // Read value from 9 buffer bytes

    ASSERT_EQ(value, 0x0884C80C5195D91DULL);
 ...
 * @req_id
 */
TEST(CodecTest, BitSerializerTestWriteValue)
{
    uint8_t aui8Buffer[10] = {0x00, 0x11, 0x22, 0x33, 0x44, 0x55, 0x66, 0x77, 0x88, 0x80};
    ...
    ASSERT_EQ(0x1122334455667788ULL, result);

    ASSERT_EQ(a_util::result::SUCCESS,
              pBits->write(15, 64, value, bit_little_endian)); // Write value into 9 buffer bytes
    ...
    ASSERT_EQ(a_util::result::SUCCESS,
              pBits->write(15, 64, value, bit_big_endian)); // Write value into 9 buffer bytes
    ...
    ASSERT_EQ(valuef, resultf);

    ASSERT_NE(valuef, result_other_endianf);

    ASSERT_EQ(a_util::result::SUCCESS,
              pBits->write(15, 64, valuef, bit_little_endian)); // Write value into 9 buffer bytes
    ...
    ASSERT_EQ(a_util::result::SUCCESS,
              pBits->read(0, 64, &result_other_endianf, bit_little_endian));
    ...
    ASSERT_EQ(a_util::result::SUCCESS,
              pBits->write(15, 64, valuef, bit_big_endian)); // Write value into 9 buffer bytes
    ...
    ASSERT_EQ(sValue, sResult);

    ASSERT_EQ(a_util::result::SUCCESS,
              pBits->write(15, 64, sValue, bit_little_endian)); // Write value into 9 buffer bytes
    ...
    ASSERT_EQ(a_util::result::SUCCESS,
              pBits->write(15, 64, sValue, bit_big_endian)); // Write value into 9 buffer bytes
