...
namespace mapping {
/**
 * @brief container type for mapping errors
 *
 */
...
public:
    ...
    /**
     * CTOR
     * @param [in] to Name of assigned signal or element
     */
...
private:
     ...
     * @param [in] assignment The dom element from which to import
...
private:
    ...
    std::string _function; // "simulation_time" -> no args, "trigger_counter" -> arg in modulo,
                           // "received" -> arg in from
    std::string _modulo;
    std::string _to;
...
/**
 * @brief compares the Assignments
 *
 * @param a left Assignments
 * @param b right Assignments
 * @return true the Assignments are equal
 * @return false the Assignments are not equal
 */
 ...
 * @param a left Assignments
 * @param b right Assignments
 * @return false the Assignments are equal
 * @return true the Assignments are not equal
 */
inline bool operator!=(const MapAssignment& a, const MapAssignment& b)
{
    return !(a == b);
