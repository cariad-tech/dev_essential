...
public:
    ...
    virtual void CreateCodec(const char* strStructName,
                             ...
                             void* pData,
                             size_t nDataSize) = 0;
    virtual timestamp_t TestAccessAllElements(size_t nRepeats,
...
public:
    ...
    timestamp_t TestAccessAllElements(size_t nRepeats,
                                      const char* strStructName,
                                      const char* strDescription,
                                      void* pData,
                                      size_t nDataSize)
...
void TestPerf(const char* strStructName, const char* strDescription, void* pData, size_t nDataSize)
{
    ...
    for (std::list<cTestPerf*>::iterator it = oTesters.begin(); it != oTesters.end(); ++it) {
        timestamp_t nTime =
            (*it)->TestAccessAllElements(nRepeats, strStructName, strDescription, pData, nDataSize);
